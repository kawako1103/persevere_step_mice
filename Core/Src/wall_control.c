...
float v_l;
float v_r;
float CENTER_L=565;//機体が中心にいる時の左側のセンサ値(仮) 1228以前　520/280  1228 550/315  2/17 以前550  2/18　以前545 584  565
float CENTER_R=403;//機体が中心にいる時の右側のセンサ値（仮	  315							  2/17 以前315  2/18　以前323.5
//
...
float WALLREAD_L=208;//217.5
float WALLREAD_R=151.5;//100 ///131.5壁を読むのであげた 151.5///大会用迷路では大丈夫と信じる
