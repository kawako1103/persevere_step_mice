...
float tread_width = 66.6;//トレッドミルは8.15cm=81.5 120°/60.5→95°.66°/90°が120°/90.5 150°/100.5 175°くらい/103.5 181°くらい/90°で調整すべきか 今のままだと90°が150°くらい
...
void trapezoid_acc_interupt(){//台形加速割り込み用
	if (trapezoid_flg==1){
